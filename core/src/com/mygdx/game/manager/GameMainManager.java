...
//            Gdx.app.log("sizeQW", String.valueOf(game.getPlayers().size()));
        }
    }
...
//        Gdx.app.log("sizeQW", String.valueOf(game.getPlayers().size()));
        for (int g = 0; g < game.getPlayers().size(); g++) {
            ...
            Gdx.app.log("CHECKLIVE", String.valueOf(game.parent.getPlayerPreferences().get(g).getBoolean(LIVE)));
            Gdx.app.log("namePla", String.valueOf(game.parent.getPlayerPreferences().get(g).getString(NAME)));
//            Gdx.app.log("whatG", String.valueOf(game.parent.getPlayerPreferences().get(g).getFloat(X)));
        }
        for (int i = game.getPlayers().size(); i < 4; i++){
            Gdx.app.log("what", "false");
            game.parent.getPlayerPreferences().get(i).putBoolean(LIVE, false);
            Gdx.app.log("whatF", String.valueOf(game.parent.getPlayerPreferences().get(i).getBoolean(LIVE)));
...
//            Gdx.app.log("sizeQW", String.valueOf(game.getPlayers().size()));
    ...
    public void loadPlayers(){
        for (int g = 0; g < game.parent.getPlayerPreferences().size(); g++){
            Gdx.app.log("player", "no");
            Gdx.app.log("player", String.valueOf(game.parent.getPlayerPreferences().get(g).getBoolean(LIVE)));
            if (game.parent.getPlayerPreferences().get(g).getBoolean(LIVE)){
                Gdx.app.log("player", "yes");
