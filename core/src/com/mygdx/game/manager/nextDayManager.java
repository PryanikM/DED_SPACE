...
//                Gdx.app.log("YES", "Check");
                ...
                for (int i = 0; i < main.getPlayers().size(); i++){
                    ...
                    saveThings();
                    saveOptions();
                    Gdx.app.log("NEXTDAYMANAGER", "THREAD OVER");
                }
        });
    }
...
//                       main.updateFood();
    ...
    private void setMinusDayBuildings(){//обновление перемпенных
        ...
        if (!main.parent.getBuildingBuildScreen().getManager().getWhoRock().equals("null")){
            Gdx.app.log("rock", String.valueOf(main.parent.getBuildingBuildScreen().getManager().getRockFacoryTimeBisy()));
