...
//    private float k;//константа экарана
    ...
    private final static String T0 = "T0";//константа для сохрванения
    private final static String T1 = "T1";//константа для сохрванения
    private final static String T2 = "T2";//константа для сохрванения
    private final static String T3 = "T3";//константа для сохрванения
    private final static String T7 = "T7";//константа для сохрванения
