    ...
    public void show() {
        ...
        ClickListener backButtonListener = new ClickListener() {
            ...
            public void clicked(InputEvent in, float x, float y) {
                Gdx.app.log("BACK", "back");
                parent.changeScreen(MyGdxGame.GAMEPLAY);
            }
        };
        backButton.addListener(backButtonListener);
        if (parent.getGameScreen().getWhatBuildingPressed().equals("water")){
            whoWorkImage.setDrawable(new TextureRegionDrawable(A2DAssetManager.manager.get("Image/" + parent.getBuildingsMakeNoScreen().getManager().getWhoWater() + "S.png", Texture.class)));
        ...
        if (parent.getGameScreen().getWhatBuildingPressed().equals("food")){
            whoWorkImage.setDrawable(new TextureRegionDrawable(A2DAssetManager.manager.get("Image/" + parent.getBuildingsMakeNoScreen().getManager().getWhoFood() + "S.png", Texture.class)));
        ...
        if (parent.getGameScreen().getWhatBuildingPressed().equals("rock")){
            whoWorkImage.setDrawable(new TextureRegionDrawable(A2DAssetManager.manager.get("Image/" + parent.getBuildingsMakeNoScreen().getManager().getWhoRock() + "S.png", Texture.class)));
