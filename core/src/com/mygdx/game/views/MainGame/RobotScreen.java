    ...
    public void show() {
        ...
        giveButton = new ClickListener(){
            ...
            public void clicked(InputEvent in, float x, float y) {
                ...
                if (parent.getGameScreen().getMainManager().getThings().indexOf(parent.getGameScreen().getRobot().getWhat()) != -1){
                ...
                else if (parent.getGameScreen().getRobot().getWhat() == 0 && (parent.getGameScreen().getMainManager().getFood() - Integer.valueOf(String.valueOf(count.getText())) >= 0)){
                    ...
                    Gdx.app.log("DELETEWA", String.valueOf(parent.getGameScreen().getRobot().getThings().get(pos)));
                    parent.getGameScreen().getRobot().getThings().remove(pos);
                    parent.getGameScreen().getRobot().save();
                    parent.changeScreen(MyGdxGame.GAMEPLAY);
                }
                else if (parent.getGameScreen().getRobot().getWhat() == 2 && (parent.getGameScreen().getMainManager().getRock() - Integer.valueOf(String.valueOf(count.getText())) >= 0)){
