...
import com.mygdx.game.manager.ContinueManager;
...
public class MenuScreen implements Screen {
    ...
    public MenuScreen(MyGdxGame myGdxGame, SpriteBatch batch) {
        ...
        Gdx.app.log("screen", String.valueOf(viewport.getCamera().viewportHeight));
...
//                exitDia.setBounds(300, 100, 600, 200);
        ...
        newGame.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
                Gdx.app.log("NEWGAME", String.valueOf(prefs.getBoolean(PREFERENCES_CONTINUE)));
